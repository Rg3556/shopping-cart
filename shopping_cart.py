...
## Receipt option: Paper vs Email

while True:
    receipt_option = input("Would you like a paper or email receipt, please choose p or e: ")
    if receipt_option == "p":
        ...
        template_data = {
            ...
            "products":[matching_product] # I tried different ways but couldn't find ways to show all the items in the mail.
...
exit # proceeds into the next iteration of the loop (OK to omit in this basic example because there is no more code following it inside the loop before the loop repeats)
